...
var Intl_date_time_format = require("./intl_date_time_format");
...
var datetime_format = Intl_date_time_format.make(/* Some */[{
        hour12: /* false */0,
        year: /* numeric */734061261,
        month: /* numeric */734061261,
        day: /* numeric */734061261,
        hour: /* numeric */734061261,
        minute: /* numeric */734061261,
        second: /* numeric */734061261
      }], /* Some */[/* :: */[
        "en-CA-u-ca-iso8601",
        /* [] */0
      ]], /* () */0);
                            ...
                            /* :: */[
                              ...
                              /* :: */[
                                Cycle_dom.h("span.button.is-small.is-disabled", /* None */0, /* :: */[
                                      Cycle_dom.text(datetime_format.format(match[0]) + " "),
                                      /* [] */0
                                    ]),
                                /* [] */0
                              ]
...
function update(t, param) {
  switch (param.tag | 0) {
    case 0 : 
        ...
        return /* tuple */[
                Id.incr(next_id),
                Map_tree.add(/* Some */[parent_id], next_id, reply, param$1[1])
              ];
    case 1 : 
        var id = param[0];
        var param$2 = t;
